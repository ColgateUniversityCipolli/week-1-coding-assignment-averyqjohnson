...
set.seed(1313)
canvas_collatz(colors = colorPalette("blossom"), background="#1e1e2f", n=300, angle.even=0.15, angle.odd=-0.1)
...
<<eval=TRUE, size="scriptsize", warning=FALSE, message=FALSE>>=
num.vec <- 0:10
num.vec
@
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
<<eval=TRUE, size="scriptsize", warning=FALSE, message=FALSE>>=
results <- 2^(num.vec+1)+2^(num.vec-1)
results
@
...
<<eval=TRUE, size="scriptsize", warning=FALSE, message=FALSE>>=
index.of.result.40 <- which(results==40)
index.of.result.40
...
<<eval=TRUE, size="scriptsize", warning=FALSE, message=FALSE>>=
solution <- num.vec[index.of.result.40]
solution
